...
m = Map("modem", translate("自定义模块支持"), translate("更改特定模块使用的数据和通信端口"))
...
e = m:section(TypedSection, "new", "模块 端口")   

a1 = e:option(Value, "vid", "模块 VID :"); 
a1.optional=false;

b1 = e:option(Value, "pid", "模块 PID :"); 
b1.optional=false; 

p3 = e:option(ListValue, "port", "使用PPP拨号端口 :")
...
p4 = e:option(ListValue, "comm", "通信端口 :")
...
btn.inputtitle = translate("删除模块端口数据库")
btn.inputstyle = "应用"
function btn.write()
