...
static int s_9x07 = 0;  //modified by chenlei
...
#if 1
static void longsung_convert_cdma_mcc_2_ascii_mcc( USHORT *p_mcc, USHORT mcc )
{
...
static void longsung_convert_cdma_mnc_2_ascii_mnc( USHORT *p_mnc, USHORT imsi_11_12)
{
    ...
    while (remainingLen > 0) {
        ...
        case 0x16: // HDR
            ...
            if(!requestGetHomeNetwork(&cmda_mcc, &cdma_mnc,NULL, NULL) && cmda_mcc) {
                longsung_convert_cdma_mcc_2_ascii_mcc(&MobileCountryCode, cmda_mcc);
                longsung_convert_cdma_mnc_2_ascii_mnc(&MobileNetworkCode, cdma_mnc);
            }
            break;
        case 0x17: // GSM
            // GSM_SYSTEM_INFO
